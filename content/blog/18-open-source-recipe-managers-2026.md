...
- Ecosystem of tools: [CookCLI](/cli/) for shopping lists and a local web server, a free [recipe app](/app/) for iOS and Android, [Obsidian plugin](/blog/15-cooklang-obsidian-guide/), VS Code extension
