...
date: 2026-08-12T18:58:51+00:00
---


HTTP endpoints for building integrations against this CookCLI server.

Start the server with [`cook server`](server); every endpoint below is served by it. The same reference is available from a running server at `/api-docs`, where the base URL reflects the host you reached it on.
